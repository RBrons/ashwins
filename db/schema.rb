...
ActiveRecord::Schema.define(version: 20171115171249) do
  ...
  create_table "entities", force: :cascade do |t|
    ...
    t.string   "basichonorific"
    t.boolean  "is_basichonorific"
  ...
  create_table "properties", force: :cascade do |t|
    ...
    t.string   "last_sub_tab"
    t.string   "taxes_and_fees_additional_rent"
    t.string   "taxes_and_fees_additional_rent_rating"
    t.string   "taxes_and_fees_additional_rent_section"
    t.string   "taxes_and_fees_net_nature"
    t.string   "taxes_and_fees_net_nature_rating"
    t.string   "taxes_and_fees_net_nature_section"
    t.string   "premises_quiet_enjoyment"
    t.string   "premises_quiet_enjoyment_rating"
    t.string   "premises_quiet_enjoyment_section"
    t.string   "lease_rent_abatement_section"
    t.string   "lease_percentage_rent_exclusions_section"
    t.string   "taxes_and_fees_restate_section"
    t.string   "taxes_and_fees_assessments_section"
    t.string   "taxes_and_fees_separate_tax_parcel_section"
    t.string   "taxes_and_fees_landlord_contesting_section"
    t.string   "taxes_and_fees_tenant_contesting_section"
    t.string   "taxes_and_fees_easements_section"
    t.string   "site_preparation_env_obligations_section"
    t.string   "site_preparation_env_termination_rights_section"
    t.string   "site_preparation_env_remediation_section"
    t.string   "site_preparation_env_permits_and_licenses_section"
    t.string   "construction_section"
    t.string   "construction_deadline_section"
    t.string   "construction_liens_section"
    t.string   "construction_approval_of_plans_and_specs_section"
    ...
    t.string   "premises_ownership_and_removal_section"
    t.string   "premises_repairs_section"
    t.string   "premises_compliance_with_laws_section"
    t.string   "premises_surrender_section"
    t.string   "premises_inspection_section"
    t.string   "premises_insurance_section"
    t.string   "premises_destruction_section"
    t.string   "premises_total_taking_section"
    t.string   "premises_partial_taking_section"
    t.string   "premises_signs_section"
    t.string   "premises_utilities_section"
    t.string   "transfer_assignment_and_subletting_section"
    t.string   "transfer_leasehold_mortgage_section"
    t.string   "transfer_subordination_section"
    t.string   "transfer_estoppel_certificate_section"
    t.string   "remedies_rent_defaults_section"
    t.string   "remedies_landlord_section"
    t.string   "remedies_mitigation_section"
    t.string   "remedies_dispute_resolution_section"
    t.string   "remedies_landlord_exoneration_section"
    t.string   "remedies_exculpation_section"
    t.string   "misc_notices_section"
    t.string   "misc_obligation_section"
